...
LastEditTime: 2024-08-06 11:23:54
...
class VLCS(DatasetBase):
    ...
    def __init__(self, cfg):
        ...
        self.image_dir = osp.join(self.dataset_dir, "sketch")
        self.split_dir = osp.join(self.dataset_dir, "splits")
        self.split_fewshot_dir = osp.join(self.dataset_dir, "split_fewshot")
        mkdir_if_missing(self.split_fewshot_dir)

        train = self._read_data(["sketch"], split="train")
        val = self._read_data(["sketch"], split="test")
        test = self._read_data(["sketch"], split="test")
