...
LastEditTime: 2024-07-21 01:55:23
...
class Office31(DatasetBase):
    """Office31 to process the product task data in Office-home.
    ...
    def __init__(self, cfg):
        ...
        self.image_dir = osp.join(self.dataset_dir, "Product")
        self.split_path = osp.join(self.dataset_dir, "split_zhou_office-home_product.json")
